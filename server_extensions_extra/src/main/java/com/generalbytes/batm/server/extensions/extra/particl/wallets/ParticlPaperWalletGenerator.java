...
import com.generalbytes.batm.server.extensions.extra.particl.ParticlMainNetParams;
...
/**
 *
 * TODO: needs bitcoinj and other stuff
 *
 * @author Juha Kovanen, Particl Project
 */
public class ParticlPaperWalletGenerator implements IPaperWalletGenerator {

    private static final String CRYPTOCURRENCY = ICurrencies.PART;
...
*/
     ...
     * @return
     */
    private ParticlPaperWallet generateWallet(String passphrase, String language) {

        ParticlPaperWallet particlPaperWallet = new ParticlPaperWallet();
/*
        ...
        particlPaperWallet.setPrivateKey(privateKeyAsWIF);
        particlPaperWallet.setAddress(currentReceiveAddress.toString());
        particlPaperWallet.setContent(zipFile);
        particlPaperWallet.setMessage(getMessage(language));
*/
        return particlPaperWallet;
    }
    ...
    public String getMessage(String language) {
        ...
        ResourceBundle translations = ResourceBundle.getBundle("i18n.particl", locale);
