...
public class ParticldRPCWallet implements IWallet{
    private static final Logger log = LoggerFactory.getLogger(ParticldRPCWallet.class);
    private static final String CRYPTO_CURRENCY = ICurrencies.PART;

    private String accountName;
    private BitcoinJSONRPCClient client;


    public ParticldRPCWallet(String rpcURL, String accountName) {
    ...
    public String sendCoins(String destinationAddress, BigDecimal amount, String cryptoCurrency, String description) {
        if (!CRYPTO_CURRENCY.equalsIgnoreCase(cryptoCurrency)) {
            log.error("Particld wallet error: unknown cryptocurrency.");
            return null;
        }

        log.info("Particld sending coins from " + accountName + " to: " + destinationAddress + " " + amount);
        try {
    ...
    public BigDecimal getCryptoBalance(String cryptoCurrency) {
        ...
        try {
            ...
            return new BigDecimal.valueOf(balance);
        } catch (BitcoinException e) {
            e.printStackTrace();
            return null;
        }
